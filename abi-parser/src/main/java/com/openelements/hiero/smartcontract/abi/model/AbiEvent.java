...
/**
 * Represents an event in the ABI (Application Binary Interface) of a smart contract.
 * More information can be found at <a href="https://docs.soliditylang.org/en/latest/abi-spec.html#events">Solidity ABI Specification for Events</a>.
...
public record AbiEvent(@NonNull String name, @NonNull List<AbiParameter> inputs, boolean anonymous) implements AbiEntry{
    ...
    /**
     * Constructs a new {@code AbiEvent} with the specified name, input parameters, and anonymous flag.
     * @param name the name of the event
     * @param inputs the input parameters of the event
     * @param anonymous indicates whether the event is anonymous
     */
