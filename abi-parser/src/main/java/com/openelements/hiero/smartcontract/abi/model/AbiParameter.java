 ...
 * @param components the list of components (if the type is a tuple, see https://docs.soliditylang.org/en/latest/abi-spec.html#handling-tuple-types)
...
public record AbiParameter(@NonNull String name, @NonNull AbiParameterType type, @NonNull List<AbiParameter> components,
    ...
    /**
     * Constructs a new {@code AbiParameter} with the specified name, type, components, and indexed flag.
     * @param name the name of the parameter
     * @param type the type of the parameter
     * @param components the list of components (if the type is a tuple)
     * @param indexed indicates if the parameter is indexed
     */
    public AbiParameter(@NonNull String name, @NonNull AbiParameterType type, @NonNull List<AbiParameter> components,
            boolean indexed) {
