...
public record AbiFunction(@NonNull AbiEntryType type, @Nullable String name, @NonNull List<AbiParameter> inputs,
    ...
    /**
     * Constructs a new {@code AbiFunction} with the specified type, name, input parameters, output parameters, and state mutability.
     * @param type the type of the function
     * @param name the name of the function
     * @param inputs the input parameters of the function
     * @param outputs the output parameters of the function
     * @param stateMutability the state mutability of the function
     */
    public AbiFunction(@NonNull AbiEntryType type, @Nullable String name, @NonNull List<AbiParameter> inputs,
            @NonNull List<AbiParameter> outputs,
